...
public class Main {
    public static void main(String[] args) {
        ...
        logs.add(new RegistroLogs("Gabriel", "888.999.000-21", 95.0, 75.0, 90.0, new Date()));
        ...
        logs.add(new RegistroLogs("Gabriel", "666.777.888-09", 81.9, 60.2, 92.1, new Date()));
        logs.add(new RegistroLogs("Gabriel", "999.000.111-32", 88.2, 64.8, 95.4, new Date()));
